...
C {devices/vsource.sym} -230 90 0 0 {name=V3 value=0 savecurrent=false}
C {devices/lab_pin.sym} -230 140 0 0 {name=p1 sig_type=std_logic lab=0}
...
C {devices/lab_pin.sym} -230 40 0 0 {name=p4 sig_type=std_logic lab=cont}
...
C {devices/vsource.sym} -160 90 0 0 {name=V4 value=1.8 savecurrent=false}
C {devices/lab_pin.sym} -160 40 0 0 {name=p13 sig_type=std_logic lab=cont_n}
